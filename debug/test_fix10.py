    ...
    def decode_hash_format(self, sdd, ln_n=384):
        ...
        while sft < len(sdd):
            ...
            if char in CMDS_T0:
                ...
                # JS: substring(sft+1, sft+v2b) extracts (v2b - 1) characters
                ...
                # JS: substring(sft, sft+3) extracts 3 characters
                v2o = sdd[sft : sft + 3]
                sft += 3
                v2t = 2
            elif char == "8" or char == "9":
                if char == "9":
                    # JS: substring(sft+2, sft+4) -> 2 characters
            ...
            if v2t != 2:
                ...
                # JS processing for v2o string (2 chars per step)
                i2 = 0
                while i2 < len(v2o):
                    if v2c == 0:
                        ob2_char = v2o[i2]
                    ...
                    if i2 < len(v2o):  # Check if index is valid
                        ch1  = v2o[i2]
                        ch2  = v2o[i2+1] if i2+1 < len(v2o) else None
                        
                        if ch2 is None:
                            break # need 2 characters for B64
                        ...
                        # lane=8 is skipped in JS (hids condition)
                        if lane < 8:
