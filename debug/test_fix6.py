...
class TextageDecoder:
    ...
    def decode_hex_format(self, sdd, ln_n=384):
        ...
        div = 0
        while idx < len(sdd):
            # JS logic: while(sdd.charAt(sft)=="@"){ div+=...; sft+=3; }
            ...
            # JS logic: for(;sft<sdd.length;sft+=2,div+=2)
            idx += 2
            div += 2
...
if __name__ == "__main__":
    ...
    if data:
        ...
        total = sum(1 for notes in data["normal"].values() for n in notes if n.get("type") != "cn_end")
